        ...
        <tr valign="top"> 
          ...
          <td width="509" height="100%"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
              ...
              <tr> 
                <td align="center" valign="top" class="text4"><br><br>
<%
  Rs.Source = "SELECT * FROM TblSalopiadinhas"
  Rs.Open()
  If Not Rs.EOF Then
	Do Until Rs.EOF
	  %><%=Rs("TextoSalopiadinha")%><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font class="text2"><%=Rs("AutorSalopiadinha")%></font><br><br><%
	  Rs.MoveNext
	Loop
  Else
	%><br><br>Nenhuma Salopiadinha foi encontrada no banco de dados<br>Reclamem com o Salomão hehhehehehe <font class="text2">:P</font><%
  End If
  Rs.Close()
%>
                </td>
