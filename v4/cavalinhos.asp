            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
              ...
              <tr> 
                <td align="center" valign="top" class="text4">
                  <p>Hehehehehe... divirta-se, n&atilde;o temos mais nada a dizer</p>
                  <p><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="480" height="261">
                      <param name=movie value="flashes/cavalinhos.swf">
                      <param name=quality value=high>
                      <embed src="flashes/cavalinhos.swf" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="480" height="261">
                      </embed> 
                    </object></p>
                </td>
              </tr>
