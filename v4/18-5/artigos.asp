                ...
                <td align="center" valign="top" class="text4"> 
                  <%
					If Request.QueryString("cod") = "" Then
					  ...
					  Do Until Rs.EOF
						%>
                  <a href="artigos.asp?cod=<%=Rs("CodigoArtigo")%>" class="text2" onMouseOver="this.className='text3';" onMouseOut="this.className='text2';"><%=Rs("TituloArtigo")%> - <%=Rs("AutorArtigo")%> (<%=Rs("DataArtigo")%>)</a><br>
                  <%
						cArtigos = cArtigos + 1
						Rs.MoveNext
					  Loop
					%><br><br>Total de artigos -> <%=cArtigos%><%
					Else
                  ...
                  <table cellpadding=0 cellspacing=0 width="95%">
                    <tr align="center">
                      <td bgcolor="#DEDEDE" width="482"><font face="Verdana, Arial, Helvetica" size="5"><b><%=Rs("TituloArtigo")%></b></font><br></td></tr><tr class="text3m">
                      <td width="482"><br>
                        <%=Rs("TextoArtigo")%><br>
                      </td></tr><tr>
                      <td align="left" class="text3" bgcolor="#DEDEDE" width="482"><%=Rs("AutorArtigo")%> (<%=Rs("DataArtigo")%>)</td></tr></table>
                  <%
					  Else
						Response.Redirect "artigos.asp"
					  End If
					End If
					Rs.Close()
				  %>
