...
<table width="100%" border="1" cellspacing="3" cellpadding="0" height="100%">
  ...
  <tr bgcolor="#FFFFFF"> 
    <td valign="top" align="center" class="text2m"> 
      ...
      <img src="imgs/int.gif" width="16" height="16"><br>
      <a href="gerenc.asp?func=salopiadinhas" class="text2m" onMouseOver="this.className='text3m';" onMouseOut="this.className='text2m';">Salopiadinhas</a><br>
      <img src="imgs/int.gif" width="16" height="16"><br>
...
Case "bomburgoes"
  If Request.QueryString("cod") = "" Then
	'Mostrar todos
	'Primeiro, mostrar os resultados, depois, as categorias
	Rs.Source = "SELECT TblBomburgoes.*, TblCategorias.*, TblIntegrantes.* FROM TblIntegrantes INNER JOIN (TblCategorias INNER JOIN TblBomburgoes ON TblCategorias.CodigoCategoria = TblBomburgoes.CategoriaBomburgao) ON TblIntegrantes.CodigoIntegrante = TblBomburgoes.IntegranteBomburgao ORDER BY TblBomburgoes.CategoriaBomburgao"
	Rs.Open()
	If Not Rs.EOF Then %>
	  Bomburgão:<br>
	  <br>
	  ...
	  Do Until Rs.EOF %>
		<tr>
		  <td>
            <div align="center"><a href="gerenc.asp?func=bomburgoes&cod=<%=Rs("CodigoBomburgao")%>" class="text4" onMouseOver="this.className='text3';" onMouseOut="this.className='text4';">:: 
              <%=Rs("NomeIntegrante")%> ::</a></div>
          </td>
		  <td>
            <div align="center"><%=Rs("NomeCategoria")%></div>
          </td>
		  <td>
            <div align="center"><%=Rs("Parametro2Bomburgao") & " " & Rs("Parametro1Bomburgao")%></div>
          </td>
		</tr>
	  <%
		Rs.MoveNext
	  Loop %>
	  </table><br><br><form method="POST" action="gerenc.asp?func=bomburgoes&cod=0">
        <input type="submit" value="Novo" class="botao1">
      </form><br><br><%
	Else
	  %>Nenhum Bomburgão encontrado no banco de dados
	  <br><br><form method="POST" action="gerenc.asp?func=bomburgoes&cod=0">
        <input type="submit" value="Novo" class="botao1">
      </form><br><br>
	  <%
	End If
	Rs.Close()
	Rs.Source = "SELECT * FROM TblCategorias"
	Rs.Open()
	If Not Rs.EOF Then %>
	  Categorias:<br>
	  <br>
      <table width="35%" cellpadding="0" cellspacing="2" bgcolor="#DEDEDE" class="text4" border="1">
        <tr align="center" class="text2">
	  ...
	  Do Until Rs.EOF %>
		<tr>
		  <td align="center"><a href="gerenc.asp?func=bomburgoes&cod=-<%=Rs("CodigoCategoria")%>" class="text4" onMouseOver="this.className='text3';" onMouseOut="this.className='text4';">:: <%=Rs("NomeCategoria")%> ::</a></td>
		  <td align="center"><%=Rs("SistemaCategoria")%></td>
		</tr>
	  <%
		Rs.MoveNext
	  Loop %> 
  ...
  ElseIf Request.QueryString("cod") = "0" Then
	'Novo Bomburgão
	%>Novo Bomburgão:<br>
	<br><form method="post" action="salvar.asp?func=bomburgoes&cod=0">
        <table width="90%" border="1" cellspacing="2" cellpadding="0" bgcolor="#DEDEDE">
          <tr align="center" class="text4"> 
            <td>Integrante</td>
            <td>Categoria</td>
            <td>Complemento(Texto)</td>
            <td>Complemento(Número)*</td>
          </tr>
          <tr align="center" class="text4"> 
            <td>
              <select name="Integrante" class="textbox1">
				<%
				'Listar Integrantes
				...
				Do Until Rs.EOF
				%>
                <option value="<%=Rs("CodigoIntegrante")%>"><%=Rs("NomeIntegrante")%></option>
				<%
				  Rs.MoveNext
				Loop
				Rs.Close()
            ...
            <td>
              <select name="Categoria" class="textbox1">
				<%
				'Listar Categorias
				Rs.Source = "SELECT * FROM TblCategorias"
				Rs.Open()
				Do Until Rs.EOF
				%>
                <option value="<%=Rs("CodigoCategoria")%>"><%=Rs("NomeCategoria")%></option>
				<%
				  Rs.MoveNext
				Loop
				Rs.Close()
			...
			<td>
              <input type="text" name="Parametro1" class="textbox1" size="10" maxlength="50">
            </td>
			<td>
              <input type="text" name="Parametro2" class="textbox1" maxlength="50" size="10">
            </td>
          </tr>
        </table><br><br>
        <input type="submit" value="Salvar" class="botao1"><br><br>
        * Digite apenas n&uacute;meros neste campo, sem espa&ccedil;o<br>
      </form>
      <%
  ElseIf Request.QueryString("cod") = "-0" Then
	'Nova Categoria
	...
	<br><form method="post" action="salvar.asp?func=bomburgoes&cod=-0">
        <table width="90%" border="1" cellspacing="2" cellpadding="0" bgcolor="#DEDEDE">
          ...
          <tr align="center" class="text4"> 
            <td> 
              <input type="text" name="Nome" size="30" class="textbox1">
            </td>
            <td> 
              <input type="text" name="Sistema" size="1" maxlength="1" class="textbox1">
              0 ou 1</td>
          </tr>
        </table>
        <p><br>
          ...
          <br>
          Sistema:</p>
        <p>0- O primeiro lugar &eacute; o que tiver o maior n&uacute;mero no complemento 
          num&eacute;rico do Bomburg&atilde;o<br>
          1- O primeiro lugar &eacute; o que tiver o menor n&uacute;mero no complemento 
          num&eacute;rico do Bomburg&atilde;o<br>
          2- Sem unidade de medidia. Prencha s&oacute; o campo num&eacute;rico, 
          simbolicamente <br>
        </p>
      </form>
      <%
  ElseIf Mid(Request.QueryString("cod"),1,1) = "-" Then
	'Mostrar\Editar apenas uma categoria
	Rs.Source = "SELECT * FROM TblCategorias WHERE CodigoCategoria=" & Mid(Request.QueryString("cod"),2)
	Rs.Open()
	If Not Rs.EOF Then
	  %>Categoria:<br><br><br>
      <form method="post" action="salvar.asp?func=bomburgoes&cod=-<%=Rs("CodigoCategoria")%>">
        <table cellspacing="2" cellpadding="0" border="1" bgcolor="#DEDEDE" width="90%" class="text3">
          <tr align="center" class="text2"> 
            <td>Nome</td>
            <td>Sistema</td>
          ...
          <tr align="center" class="text4"> 
            <td> 
              <input type="text" name="Nome" value="<%=Rs("NomeCategoria")%>" size="50" class="textbox1">
            </td>
            <td> 
              <input type="text" name="Sistema" size="1" maxlength="1" value="<%=Rs("SistemaCategoria")%>" class="textbox1">
            </td>
            <td>
              <input type="checkbox" name="delcategoria" value="1">
               deletar
			</td>
          </tr>
        </table><br><br>
...
<p>0- O primeiro lugar &eacute; o que tiver o maior n&uacute;mero no complemento 
          num&eacute;rico do Bomburg&atilde;o<br>
          1- O primeiro lugar &eacute; o que tiver o menor n&uacute;mero no complemento 
          num&eacute;rico do Bomburg&atilde;o<br>        <br>
      </form>
      <%
	Else
	  %><br><br>A Categoria não existe mais<br><br><%
	End If
	Rs.Close()
  Else
	'Mostrar\Editar apenas um bomburgão
	Rs.Source = "SELECT TblBomburgoes.*, TblCategorias.*, TblIntegrantes.* FROM TblIntegrantes INNER JOIN (TblCategorias INNER JOIN TblBomburgoes ON TblCategorias.CodigoCategoria = TblBomburgoes.CategoriaBomburgao) ON TblIntegrantes.CodigoIntegrante = TblBomburgoes.IntegranteBomburgao WHERE CodigoBomburgao=" & Request.QueryString("cod")
	Rs.Open()
	If Not Rs.EOF Then
	  %>Bomburgão:<br><br><br>
      <form method="post" action="salvar.asp?func=bomburgoes&cod=<%=Rs("CodigoBomburgao")%>">
        <table cellspacing="2" cellpadding="0" border="1" bgcolor="#DEDEDE" width="90%" class="text3">
          <tr align="center" class="text2"> 
            <td>Integrante</td>
            <td>Categoria</td>
          ...
          <tr align="center" class="text4"> 
            <td>
              <select name="Integrante" class="textbox1">
				<%
				'Listar Integrantes
				lConsulta.Source = "SELECT * FROM TblIntegrantes"
				lConsulta.Open()
				Do Until lConsulta.EOF
				  If lConsulta("CodigoIntegrante") = Rs("IntegranteBomburgao") Then
					%><option value="<%=lConsulta("CodigoIntegrante")%>" SELECTED><%=lConsulta("NomeIntegrante")%></option><%
				  Else
					%><option value="<%=lConsulta("CodigoIntegrante")%>"><%=lConsulta("NomeIntegrante")%></option><%
				  End If
				  lConsulta.MoveNext
				Loop
				lConsulta.Close()
            ...
            <td>
              <select name="Categoria" class="textbox1">
				<%
				'Listar Categorias
				lConsulta.Source = "SELECT * FROM TblCategorias"
				lConsulta.Open()
				Do Until lConsulta.EOF
				  If lConsulta("CodigoCategoria") = Rs("CategoriaBomburgao") Then
					%><option value="<%=lConsulta("CodigoCategoria")%>" SELECTED><%=lConsulta("NomeCategoria")%></option><%
				  Else
					%><option value="<%=lConsulta("CodigoCategoria")%>"><%=lConsulta("NomeCategoria")%></option><%
				  End If
				  lConsulta.MoveNext
				Loop
				lConsulta.Close()
			...
			<td> 
              <input type="text" name="Parametro1" class="textbox1" size="10" maxlength="50" value="<%=Rs("Parametro1Bomburgao")%>">
            </td>
            <td> 
              <input type="text" name="Parametro2" class="textbox1" maxlength="50" size="10" value="<%=Rs("Parametro2Bomburgao")%>">
            </td>
            <td>
              <input type="checkbox" name="delbomburgao" value="1">
               deletar
			</td>
          </tr>
        </table><br><br>
      ...
      <%
	Else
	  %><br><br>O Bomburgão não existe mais<br><br><%
	End If
	Rs.Close()
  End If
Case "dicionarios"
      ...
      <form method="post" action="salvar.asp?func=dicionarios&cod=0">
        <table width="90%" border="1" cellspacing="2" cellpadding="0" bgcolor="#DEDEDE">
          ...
          <tr align="center"> 
            ...
            <td class="text3"> 
              <input type="text" name="Significado" size="50" class="textbox1">
            </td>
          </tr>
        </table><br><br>
        <input type="submit" value="Salvar" class="botao1">
      ...
      <form method="post" action="salvar.asp?func=dicionarios&cod=<%=Rs("CodigoPalavra")%>">
        <table cellspacing="2" cellpadding="0" border="1" bgcolor="#DEDEDE" width="90%" class="text3">
          ...
          <tr align="center"> 
            ...
            <td> 
              <input type="text" name="Significado" value="<%=Rs("SignificadoPalavra")%>" size="50" class="textbox1">
            </td>
            <td>
		  ...
		  Do Until lConsulta.EOF
			%>
              <tr bgcolor="#FFFFFF"> 
                ...
                <td width="80"><%=lConsulta("VotosOpcao")%> voto(s)</td>
              </tr>
              <%
			lConsulta.MoveNext
		  Loop
        ...
        <table width="90%" border="1" cellspacing="2" cellpadding="0" bgcolor="#DEDEDE">
          ...
          <tr align="center" class="text3"> 
            ...
            <td width="28"> 
              ...
              deletar</td>
            <td width="30">
              <input type="checkbox" name="zerenquete" value="1">
              zerar</td>
          </tr>
          <tr> 
      ...
      <form method="post" action="salvar.asp?func=frases&cod=<%=Rs("CodigoFrase")%>">
        <table cellspacing="2" cellpadding="0" border="1" bgcolor="#DEDEDE" width="90%" class="text3">
          ...
          <tr align="center"> 
            ...
            <td> 
              <input type="text" name="Autor" value="<%=Rs("AutorFrase")%>" maxlength="100" size="35" class="textbox1">
            </td>
            <td>
	...
	%>
        <tr align="center">
          ...
          <td><% If Rs("FotoIntegrante") <> "" Then
				   Response.Write("<img src='" & Rs("FotoIntegrante") & "' width='64' height='48' alt='" & Rs("FotoIntegrante") & "'>")
				 Else
			...
			<td colspan="3" align="right">
              <table width="80%" border="0" cellspacing="1" cellpadding="0" class="text3">
                ...
                <tr> 
                  ...
                  <td bgcolor="#FFFFFF"> 
                    <input type="text" name="N<%=Contador%>" class="textbox1" size="100">
                  </td>
                </tr>
				<%
				Next
			...
			<td colspan="4" align="right">
              <table width="80%" border="0" cellspacing="1" cellpadding="0" class="text3">
                ...
                <tr> 
                  <td bgcolor="#FFFFFF" width="100">Reportagem <%=Contador%></td>
                  <td bgcolor="#FFFFFF"> 
                    <input type="text" name="N<%=Contador%>" value="<%=Rs("N" & Contador & "Jornal")%>" class="textbox1" size="100">
                  </td>
                </tr>
				<%
				Next
        ...
        <table cellspacing="2" cellpadding="0" border="1" bgcolor="#DEDEDE" width="90%" class="text3">
          ...
          <tr align="center"> 
			...
			<td><% If Rs("StatusMenu") = 1 Then 
			          Response.Write("<input type='checkbox' name='Status' value='1' checked> ativar")
					Else
					  Response.Write("<input type='checkbox' name='Status' value='1'> ativar")
					End If %>
            </td>
            <td>
...
Case "newspro"
  If Request.QueryString("cod") = "" Then
	...
	If Not Rs.EOF Then
      ...
      <form method="POST" action="gerenc.asp?func=newspro&cod=0">
        <input type="submit" class="botao1" value="Novo">
      </form>      
      <table width="90%" cellpadding="0" cellspacing="2" bgcolor="#DEDEDE" class="text4" border="1">
        <tr align="center" class="text2"> 
          <td>Titulo</td>
		...
		<tr>
            <td>
            <div align="center"><a href="gerenc.asp?func=newspro&cod=<%=Rs("CodigoNews")%>" class="text4" onMouseOver="this.className='text3';" onMouseOut="this.className='text4';">:: 
              <%=Rs("TituloNews")%> ::</a></div>
          </td>
		    <td>
            <div align="center"><%=Rs("AutorNews")%></div>
          </td>
            <td>
            <div align="center">
              <% If Rs("AvatarNews") <> "" Then
			...
			<td>
            <div align="center"><%=Rs("DataNews")%></div>
          </td>
			<td><%=Rs("TextoNews")%></td>
		</tr>
		  <%
	...
	%>
	  ...
	  <table width="90%" cellpadding="0" cellspacing="2" bgcolor="#DEDEDE" class="text4" border="1">
		...
		<tr align="center">
			...
			<td><textarea name="Texto" cols="50" rows="6" class="textbox1"></textarea></td>
			<td><input type="checkbox" value="1" name="preview" CHECKED></td>
		</tr>
	  </table>
        <br>
        <a onClick="Avatares();" class="text2" onMouseOver="this.className='text3';" onMouseOut="this.className='text2';" href="#">Avatares</a><br>
        <br><input type="hidden" name="Codigo" value="0"><input type="submit" value="Salvar" class="botao1"></form><br><br>
	<%
  Else
	'Mostrar/Editar apenas um
	If Not Request.QueryString("cod") = "800" Then
	  ...
	  News:<br><br><br><form method="POST" action="salvar.asp?func=newspro&cod=<%=Rs("CodigoNews")%>">
		...
		<tr align="center">
            <td>
              <input type="text" value="<%=Rs("TituloNews")%>" name="Titulo" size="15" class="textbox1" maxlength="50">
            </td>
		    <td>
              <input type="text" value="<%=Rs("AutorNews")%>" name="Autor" size="12" class="textbox1" maxlength="50">
            </td>
			...
			<td><textarea name="Texto" cols="50" rows="6" class="textbox1"><%=Rs("TextoNews")%></textarea></td>
			<td width="80">
<input type="checkbox" value="1" name="delnews">
              deletar</td>
			<td><input type="checkbox" value="1" name="preview" CHECKED></td>
		</tr>
	  </table>
        <br>
        <a onClick="Avatares();" class="text2" onMouseOver="this.className='text3';" onMouseOut="this.className='text2';" href="#">Avatares</a> 
        <br>
        <br><input type="hidden" name="Codigo" value="<%=Rs("CodigoNews")%>"><input type="submit" value="Salvar" class="botao1"></form><br><br>
	  <%
	  End If
	  Rs.Close()
	End If
...
Case "salopiadinhas"
  If Request.QueryString("cod") = "" Then
	'Mostrar todas
	Rs.Source = "SELECT * FROM TblSalopiadinhas"
	Rs.Open()
	If Not Rs.EOF Then %>
      Salopiadinhas:<br>
      <br>
	...
	%>
        <tr align="center">
          <td><a href="gerenc.asp?func=salopiadinhas&cod=<%=Rs("CodigoSalopiadinha")%>" class="text4" onMouseOver="this.className='text3';" onMouseOut="this.className='text4';">:: <%=Rs("TextoSalopiadinha")%> ::</a></td>
          <td width="30%"><%=Rs("AutorSalopiadinha")%></td>
        </tr>
        <%
		Rs.MoveNext
	  Loop %>
      </table><br><br><form method="POST" action="gerenc.asp?func=salopiadinhas&cod=0">
        <input type="submit" value="Nova" class="botao1">
      </form><br><br>
	<%
	Else
	  %>Nenhuma salopiadinha encontrada no banco de dados
	  <br><br><form method="POST" action="gerenc.asp?func=salopiadinhas&cod=0">
        <input type="submit" value="Nova" class="botao1">
      </form><br><br>
	  <%
	End If
  ...
  ElseIf Request.QueryString("cod") = "0" Then
	'Novo salopiadinha
	%>Nova Salopiadinha:
      <form method="post" action="salvar.asp?func=salopiadinhas&cod=0">
        <table width="90%" border="1" cellspacing="2" cellpadding="0" bgcolor="#DEDEDE">
          <tr align="center"> 
            <td class="text4">Texto</td>
            <td class="text4">Autor</td>
          </tr>
          <tr align="center"> 
            <td class="text3"> 
              <input type="text" name="Texto" class="textbox1" size="60">
            </td>
            <td class="text3"> 
              <input type="text" name="Autor" maxlength="50" size="36" class="textbox1">
            </td>
          </tr>
        </table><br><br>
        <input type="submit" value="Salvar" class="botao1">
  ...
  Else
	'Mostrar/Editar apenas uma
	Rs.Source = "SELECT * FROM TblSalopiadinhas WHERE CodigoSalopiadinha=" & Request.QueryString("cod")
	Rs.Open()
	If Not Rs.EOF Then
	  %>
      Salopiadinha:<br>
      <br><br>
      <form method="post" action="salvar.asp?func=salopiadinhas&cod=<%=Rs("CodigoSalopiadinha")%>">
        <table cellspacing="2" cellpadding="0" border="1" bgcolor="#DEDEDE" width="90%" class="text3">
          <tr align="center"> 
            <td class="text2">Texto</td>
            <td class="text2">Autor</td>
            <td class="text2" width="80">Op&ccedil;&otilde;es</td>
          </tr>
          <tr align="center"> 
            <td> 
              <input type="text" name="Texto" value="<%=Rs("TextoSalopiadinha")%>" size="60" class="textbox1">
            </td>
            <td> 
              <input type="text" name="Autor" value="<%=Rs("AutorSalopiadinha")%>" maxlength="50" size="35" class="textbox1">
            </td>
            <td>
              <input type="checkbox" name="delsalopiadinha" value="1">
               deletar</td>
          </tr>
        </table>
        <br>
      ...
      <%
	Else
	  %><br><br>A Salopiadinha não existe mais<br><br><%
	End If
	Rs.Close()
  End If
Case "usuarios"
...
Case Else
  %>
      ...
      <p align="justify">A linguagem <font class=text2>HTML</font> &eacute; composta 
        por <font class=text2>tags</font>, que s&atilde;o comandos expressos entre 
        sinais de maior e menor, como por exemplo, o c&oacute;digo &lt;hr&gt; 
...
function Avatares()
{
    window.open("avatares.htm","avatares","toolbar=no,scrollbars=no,directories=no,status=no,menubar=no,resizable=yes,width=500,height=155");
}
</script>
</body>
</html>
