            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
              <tr> 
                <td height="17" background="imgs/41.gif" class="text3mm" align="center"> 
                  ...
                  <form name="" method="post" action="salvarsl.asp?func=vacilos">
                    <p align="left" class="text3">Compartilhe conosco um vacilo 
                      seu ou entregue o de um companheiro:</p>
                    <p align="left"><font class="text3">Autor: 
                      <input type="text" name="Autor" maxlength="50" class="textbox1">
                      <br>
                      Vacilo: 
                      <input type="text" name="Texto" size="70" class="textbox1">
                      <br>
                      Senha SalaDois: 
                      <input type="password" name="Senha" size="6" maxlength="6" class="textbox1">
                      (uhauhuahuahauhauha)</font></p>
                  ...
                  <br><br>
                  <br><%
					Rs.Source = "SELECT * FROM TblVacilos ORDER BY CodigoVacilo DESC"
					Rs.Open()
					Do Until Rs.EOF
					  %><font class="text4">"<%=Rs("TextoVacilo")%>"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(<%=Rs("AutorVacilo")%>)<br><br></font><%
					  Rs.MoveNext
					Loop
					Rs.Close()
					%><br><br>
